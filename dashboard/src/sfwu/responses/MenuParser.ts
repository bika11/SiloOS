...
export class MenuParser {
    static parse(data: Uint8Array): ParsedMenuItem[] {
        ...
        try {
            ...
            logger.debug('TopBrewer', `Binary Menu: Count=${count}, Status=${status}`);
            ...
            for (let i = 0; i < count; i++) {
                ...
                // Price (2 bytes) - Skip for now or read generic
                offset += 2;
            ...
            logger.error('TopBrewer', 'Failed to parse binary menu', e);
        }
